...
You may want to consider using the [general metrics endpoint](/api-doc/data/metrics) instead for faster loading times and a smaller response.  That API also exposes more data.
:::
